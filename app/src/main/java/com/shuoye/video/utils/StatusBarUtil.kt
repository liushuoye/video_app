...
object StatusBarUtil {
    ...
    private const val FAKE_STATUS_BAR_VIEW_ID: Int = R.id.statusbarutil_fake_status_bar_view
    private const val FAKE_TRANSLUCENT_VIEW_ID: Int = R.id.statusbarutil_translucent_view
