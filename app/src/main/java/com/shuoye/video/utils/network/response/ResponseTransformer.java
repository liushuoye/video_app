...
import com.shuoye.video.utils.network.exception.ApiException;
import com.shuoye.video.utils.network.exception.CustomException;
...
public class ResponseTransformer {
    ...
    private static class ErrorResumeFunction<T> implements Function<Throwable, ObservableSource<? extends Response<T>>> {
        ...
        @Override
        public ObservableSource<? extends Response<T>> apply(@NotNull Throwable throwable) {
